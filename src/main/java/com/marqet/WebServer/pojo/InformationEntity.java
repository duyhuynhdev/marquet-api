...
public class InformationEntity {
    ...
    public void setHelpFAQ(String helpFAQ) {
        this.helpFAQ = helpFAQ;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (helpFAQ != null ? !helpFAQ.equals(that.helpFAQ) : that.helpFAQ != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (helpFAQ != null ? helpFAQ.hashCode() : 0);
    ...
    public JSONObject toJSON(){
        ...
        jsonObject.put("communityGuidelines",this.communityRule);
        jsonObject.put("helpFAQ",this.helpFAQ);
