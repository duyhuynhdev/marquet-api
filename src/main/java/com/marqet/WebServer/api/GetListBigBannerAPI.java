...
public class GetListBigBannerAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BigBannerController controller = new BigBannerController();
        JSONObject result = controller.getListBigBanner();
