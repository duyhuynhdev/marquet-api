...
public class PutSmallBannerAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,productId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                SmallBannerController controller = new SmallBannerController();
                JSONObject result = controller.putSmallBanner(email, productId);
