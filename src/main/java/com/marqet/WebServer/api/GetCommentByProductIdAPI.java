...
public class GetCommentByProductIdAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "startIdx,numComment,productId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                int numComment = requestJSON.getInt("numComment");
                CommentController controller = new CommentController();
                //comment product
                JSONObject result = controller.getListCommentByProductId(productId,startIdx,numComment);
