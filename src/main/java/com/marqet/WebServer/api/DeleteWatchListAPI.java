...
import com.marqet.WebServer.controller.WatchListController;
...
public class DeleteWatchListAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                //get parameter
                long watchListId = requestJSON.getLong("watchListId");
                WatchListController controller = new WatchListController();
                //add watch list
                JSONObject result = controller.deleteWatchList(watchListId);
                out.print(result);
