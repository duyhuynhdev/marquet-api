...
public class GetListFeedbackSellerAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                int numFeedback = requestJSON.getInt("numFeedback");
                FeedbackController controller = new FeedbackController();
                //get list follower
                JSONObject result = controller.getListFeedbackSeller(email,startIdx,numFeedback);
