...
public class GetListFollowingAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "emailMe,emailView,startIdx,numUser";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                //get parameter
                String emailMe = requestJSON.getString("emailMe");
                String emailView = requestJSON.getString("emailView");
                int startIdx = requestJSON.getInt("startIdx");
                int numUser = requestJSON.getInt("numUser");
                FollowController controller = new FollowController();
                //get list follower
                JSONObject result = controller.getListFollowing(emailMe,emailView,startIdx,numUser);
