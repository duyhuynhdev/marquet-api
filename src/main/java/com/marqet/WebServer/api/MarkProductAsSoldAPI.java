...
public class MarkProductAsSoldAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "productId,email";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                long producId = requestJSON.getLong("productId");
                ProductController controller = new ProductController();
                //mark as sold
                JSONObject result = (controller.markAsSold(email, producId));
