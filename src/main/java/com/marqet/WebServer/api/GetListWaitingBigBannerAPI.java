...
public class GetListWaitingBigBannerAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                BigBannerController bigBannerController = new BigBannerController();
                JSONObject result = (bigBannerController.getListWaitingBigBanner(email));
