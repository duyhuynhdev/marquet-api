...
public class DeleteActivityAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,activityId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                long activityId = requestJSON.getLong("activityId");
                ActivityController controller = new ActivityController();
                //comment product
                JSONObject result = controller.deleteActivity(email, activityId);
