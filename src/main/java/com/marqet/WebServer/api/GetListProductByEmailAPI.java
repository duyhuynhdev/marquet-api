...
public class GetListProductByEmailAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                JSONObject result = (controller.getListProductByEmail(email, SearchAndFilterUtil.LASTEST,startIdx,numProduct));
