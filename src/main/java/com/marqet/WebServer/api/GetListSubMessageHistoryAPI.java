...
public class GetListSubMessageHistoryAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,firstSubMessageId,numSubMessage,messageId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                long firstSubMessageId = requestJSON.getInt("firstSubMessageId");
                ...
                JSONObject result = (subMessageController.getSubMessageByMessageId(email,messageId, firstSubMessageId, numSubMessage));
