...
public class GetListSubMessageNewAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,lastSubMessageId,messageId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                long lastSubMessageId = requestJSON.getInt("lastSubMessageId");
                long messageId = requestJSON.getInt("messageId");
                SubMessageController subMessageController = new SubMessageController();
                JSONObject result = (subMessageController.getNewSubMessageByMessageId(email, messageId, lastSubMessageId));
