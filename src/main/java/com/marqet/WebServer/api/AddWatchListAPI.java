...
public class AddWatchListAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,pattern";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                String pattern = requestJSON.getString("pattern");
                WatchListController controller = new WatchListController();
                //add watch list
                JSONObject result = controller.addWatchList(email, pattern);
                out.print(result);
