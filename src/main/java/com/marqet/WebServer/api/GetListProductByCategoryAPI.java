...
public class GetListProductByCategoryAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "countryCode,categoryId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                JSONObject result = (controller.getListProductByCategory(countryCode, categoryId, SearchAndFilterUtil.LASTEST, startIdx, numProduct, email));
