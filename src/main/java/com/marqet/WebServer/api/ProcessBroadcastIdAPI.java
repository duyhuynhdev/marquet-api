...
public class ProcessBroadcastIdAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,broadcastId,deviceId,type";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                //get parameter
                String broadcastId = requestJSON.getString("broadcastId");
                String deviceId = requestJSON.getString("deviceId");
                String email = requestJSON.getString("email");
                int type = requestJSON.getInt("type");
                UserController controller = new UserController();
                //put regId
                JSONObject result = controller.ProcessBroardcast(email,deviceId,broadcastId,type);
