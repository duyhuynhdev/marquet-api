...
import com.marqet.WebServer.controller.ActivityController;
...
public class GetListActivityAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                long lastestId = requestJSON.getLong("lastestId");
                int numMessage = requestJSON.getInt("numActivity");
                ActivityController controller = new ActivityController();
                //get list activity
                JSONObject result = controller.getListActivity(email, lastestId, numMessage);
