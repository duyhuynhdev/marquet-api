...
public class VerifyViaFacebookAPI extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String parameters = "email,facebookId";
            ...
            if (ResponseController.isSuccess(resultCheckerJSON)) {
                ...
                String facebookId = requestJSON.getString("facebookId");
                UserController controller = new UserController();
                //verify account
                out.print(controller.verifyViaFacebook(email, facebookId));
            } else {
