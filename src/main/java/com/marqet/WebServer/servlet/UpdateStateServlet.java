...
public class UpdateStateServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException,IOException{
        ...
        try{
            ...
            JSONObject responseJSON = controller.updateState(code,name,countryCode);
            if(responseJSON.get(ResponseController.RESULT).equals(ResponseController.SUCCESS))
                ...
                request.setAttribute("errorTitle", "Update state fail");
            ...
            ex.printStackTrace();
            request.setAttribute("isError", true);
            request.setAttribute("errorTitle", "Update state exception");
